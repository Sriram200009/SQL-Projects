...
Select billing_city, sum(total) as Grand_total From invoice
group by billing_city order by Grand_total desc limit 1 ;
...
Select artist.name,Count(track.track_id) as Number_of_songs from artist
